# Contributing to SciTeX Notification

Thank you for your interest in contributing to SciTeX Notification. This guide covers the
...
- Search [existing issues](https://github.com/ywatanabe1989/scitex-notification/issues)
  before opening a new one.
- Include a minimal reproducible example when reporting bugs.
- Specify your Python version, OS, and `scitex-notification` version.

## Development Setup

```bash
git clone git@github.com:ywatanabe1989/scitex-notification.git
cd scitex-notification
pip install -e ".[dev]"
```
