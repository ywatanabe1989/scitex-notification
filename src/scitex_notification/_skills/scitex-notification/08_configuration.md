...
description: |
  [TOPIC] Configuration
  [DETAILS] scitex-notification configuration — YAML config file, UIConfig singleton, environment variables, and level-based backend routing.
tags: [scitex-notification-configuration]
---
